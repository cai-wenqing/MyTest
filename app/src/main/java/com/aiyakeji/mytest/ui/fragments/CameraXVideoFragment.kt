...
import com.aiyakeji.mytest.adapters.GenericListAdapter
import com.aiyakeji.mytest.bean.CameraCapability
import com.aiyakeji.mytest.databinding.FragmentCameraVideoBinding
import com.aiyakeji.mytest.utils.getAspectRatio
import com.aiyakeji.mytest.utils.getAspectRatioString
import com.aiyakeji.mytest.utils.getNameString
...
class CameraXVideoFragment : Fragment() {
    private val TAG = "CameraXVideo"

    private var _binding: FragmentCameraVideoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCameraVideoBinding.inflate(inflater, container, false)
        return binding.root
    ...
    private suspend fun bindCaptureUsecase() {
        ...
        binding.previewView.updateLayoutParams<ConstraintLayout.LayoutParams> {
            val orientation = this@CameraXVideoFragment.resources.configuration.orientation
        ...
        if (event is VideoRecordEvent.Finalize) {
            ...
            lifecycleScope.launch {
                navController.navigate(
                    CameraXVideoFragmentDirections.actionCaptureToVideoViewer(
    ...
    private fun initializeUI() {
        ...
        binding.ibCapture.apply {
            setOnClickListener {
                if (!this@CameraXVideoFragment::recordingState.isInitialized ||
        ...
        binding.ibStop.apply {
            setOnClickListener {
                // stopping: hide it after getting a click before we go to viewing fragment
                binding.ibStop.visibility = View.INVISIBLE
                ...
                binding.ibCapture.setImageResource(R.drawable.ic_start)
            }
    ...
    private fun updateUI(event: VideoRecordEvent) {
        ...
        when (event) {
            ...
            is VideoRecordEvent.Pause -> {
                binding.ibCapture.setImageResource(R.drawable.ic_resume)
            }

            is VideoRecordEvent.Resume -> {
                binding.ibCapture.setImageResource(R.drawable.ic_pause)
            }
        }
    ...
    private fun showUI(state: UiState, status: String = "idle") {
        binding.let {
            when (state) {
                UiState.IDLE -> {
                    it.ibCapture.setImageResource(R.drawable.ic_start)
                    it.ibStop.visibility = View.INVISIBLE

                    it.ibCamera.visibility = View.VISIBLE
                    it.audioSelection.visibility = View.VISIBLE
                    it.rvQuality.visibility = View.VISIBLE
                }

                UiState.RECORDING -> {
                    it.ibCamera.visibility = View.INVISIBLE
                    it.audioSelection.visibility = View.INVISIBLE
                    it.rvQuality.visibility = View.INVISIBLE

                    it.ibCapture.setImageResource(R.drawable.ic_pause)
                    it.ibCapture.isEnabled = true
                    it.ibStop.visibility = View.VISIBLE
                    it.ibStop.isEnabled = true
                }
            ...
            it.tvCaptureStatus.text = status
        }
    }
    ...
    companion object {
        ...
        val TAG: String = CameraXVideoFragment::class.java.simpleName
