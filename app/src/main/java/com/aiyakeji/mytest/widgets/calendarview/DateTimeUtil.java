...
public class DateTimeUtil {
     ...
     * 判断两日期是否同一天
     *
     * @param str1 2015-01-07
     * @param str2 2015-01-07
     * @return
     */
    @SuppressLint("SimpleDateFormat")
     ...
     */
    @SuppressLint("SimpleDateFormat")
    public static String formatDateGetWeek(String str, int days) {
        String dateStr = "";
        try {
     ...
     * 传入时间 算出星期几
     *
     * @param str 2014年1月3日或2014-01-03
     * @return
     */
    @SuppressLint("SimpleDateFormat")
    public static String formatDateGetWeek(String str) {
        if (str.contains("-")) {
            //2018-05-15转换成2018年05月15日
            str = formatYearMonthDay2(str);
        }
        String dateStr = "";
        try {
            DateFormat df = DateFormat.getDateInstance(DateFormat.LONG);
    ...
    /**
     * 传入日期，获取周几的index（0是周日，1是周一，依次类推）
     *
     * @param str 2014年1月3日或2014-01-03
     * @return
     */
    ...
    /**
     * 传入2018年5月15日，返回2018-05-15
     *
     * @param string
     * @return
     */
    public static String formatYearMonthDay1(String string) {
        int yearIndex = string.indexOf("年");
        int monthIndex = string.indexOf("月");

        String year = string.substring(0, yearIndex);
        String month = string.substring(yearIndex + 1, monthIndex);
        String day = string.substring(monthIndex + 1, string.length() - 1);
    ...
    /**
     * 传入2018-05-15  返回2018年05月15日
     *
     * @param string
     * @return
     */
    public static String formatYearMonthDay2(String string) {
     ...
     * 获取某年某月有几天
     *
     * @param str 2014年1月3日（日只有在当月内都可以）或2014-05-15格式
     * @return
     */
    @SuppressLint("SimpleDateFormat")
     ...
     * 获取某日期的int类型的某天
     *
     * @param date 2018-05-15
     * @return
     */
    public static int getDayNumberFromDateString(String date) {
        int result = -1;
        ...
        if (day.startsWith("0")) {
            result = Integer.valueOf(day.substring(1));
        } else {
